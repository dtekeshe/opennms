...
@Command(scope = "kafka-producer", name = "push-topology-edges", description = "Pushes all of the known topology edges to the configured topic.")
@Service
public class PushEdges implements Action {
    ...
    public Object execute() throws InvalidSyntaxException {
        ...
        final Map<OnmsTopologyProtocol, OnmsTopology> topologies =  onmsTopologyDao.getTopologies();
